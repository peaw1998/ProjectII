        ...
        <View style={styles.main}>
          ...
          <View style={styles.Example}>
            ...
            <Button style={styles.button2}>
              <Text style={styles.font3}>ตัวเลือกที่ 1</Text>
            </Button>
            <Button style={styles.button2}>
              <Text style={styles.font3}>ตัวเลือกที่ 2</Text>
            </Button>
            <Button style={styles.button2}>
              <Text style={styles.font3}>ตัวเลือกที่ 3</Text>
            </Button>
            <Button style={styles.button2}>
              <Text style={styles.font3}>ตัวเลือกที่ 4</Text>
            </Button>
          </View>
        </View>
      </>
