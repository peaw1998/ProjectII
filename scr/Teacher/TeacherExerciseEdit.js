      ...
      <>
        <View style={styles.main}>
          <TouchableOpacity
            style={styles.score}
            onPress={() => {
              this.props.navigation.navigate('คะแนนทั้งหมด', {
                exercise_ID: this.props.navigation.getParam('Data', [
                  {Question: []},
                ])[0]._id,
              });
            }}>
            <Text style={styles.font4}>ดูคะแนน</Text>
          </TouchableOpacity>
        </View>

        <View style={styles.main}>
          {this.props.navigation
            .getParam('Data', [{Question: []}])[0]
                  ...
                  onPress={() => {
                    if (item.type === 'fill')
                      this.props.navigation.navigate('แก้ไขคำถาม', {
                        index: index,
                        Question: this.props.navigation.getParam('Data', [
                          {Question: []},
                        ])[0].Question,
                        exercise_ID: this.props.navigation.getParam('Data', [
                          {Question: []},
