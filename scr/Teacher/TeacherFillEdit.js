...
export default class TeacherFill extends Component {
    ...
    Put = async () => {
        if (this.state.isPress == false) {
            ...
            arr[this.props.navigation.getParam('index', 'test')] = { correctAnswer: this.state.correctAnswer, question: this.state.question, type: "fill" }
        ...
        return (
            <>
                <View style={styles.main}>
                    ...
                    <Item style={styles.Input}>
                        <TextInput onChangeText={(e) => { this.setState({ correctAnswer: e }) }} value={this.state.correctAnswer} />
                    </Item>
